...
#     low_btn = InlineKeyboardButton(text='Low', callback_data='low_price')
...
#                                       '\nНажмите Custom  Диапазон значений выборки (цена от и до, расстояние от и до, '
#                                       'срок от и до и так далее).'
#                                       'Количество единиц категории (товаров/услуг), которые необходимо вывести (не '
#                                       'больше заранее определённого программно максимума).\n'
#                                       '\nНажмите History После ввода команды выводится краткая история запросов '
#                                       'пользователя (последние десять запросов).', reply_markup=inline_markup)
